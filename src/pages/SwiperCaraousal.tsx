        ...
        <div className="flex justify-center items-center space-x-4 transition-all duration-500 flex-col md:flex-row">
          {[prev, active, next].map((index) => {
            ...
            return (
              ...
              >
                <div className="h-40 md:h-52 w-40 md:w-52 flex items-center justify-center relative">
                  <img
                    src={partners[index].image}
                    alt={partners[index].name}
                    className="max-h-40 max-w-full object-contain"
                  />
                  <span className="absolute bottom-4 text-white font-bold text-sm sm:text-base">
                    {partners[index].name}
                  </span>
                </div>
              </div>
